 ...
 * @date 2025-08-08
 */
public class WinTransactions extends BaseEntity
{
    ...
    public WinTransactions(Long time, Long acctnbr, Long inpDate, Long inpTime, Long xtranno, BigDecimal billAmt, String org1Code, String orgNo, String custIsn, String cardStatusTxt, String custName, String certNo, String cardNo, String orgName) {
        this.time = time;
        this.acctnbr = acctnbr;
        this.inpDate = inpDate;
        this.inpTime = inpTime;
