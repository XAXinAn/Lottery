...
//                            transactionsList.remove(transaction);
            ...
            } while (sum < prize.getBudget().doubleValue() * (0.95 - looptime * 0.01) || sum >= prize.getBudget().doubleValue() || (prize == prizesList.get(prizesList.size() - 1) && org1MaxWinMapper.getOrg1Status(maxBillAmountTransaction.getOrg1Code()) == 1) );
            result.addAll(temp);
