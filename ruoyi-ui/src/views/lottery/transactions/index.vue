<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="90px">
      ...
      <el-form-item label="用户内码" prop="custIsn">
        <el-input
    ...
    <el-table v-loading="loading" :data="transactionsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户内码" align="center" prop="custIsn" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="用户内码" prop="custIsn">
          <el-input v-model="form.custIsn" placeholder="请输入用户内码" />
        </el-form-item>
        <el-form-item label="卡片状态" prop="cardStatusTxt">
...
<script>
import { listTransactions, getTransactions, delTransactions, addTransactions, updateTransactions } from "@/api/lottery/transactions"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除交易记录编号为"' + acctnbrs + '"的数据项？').then(function() {
